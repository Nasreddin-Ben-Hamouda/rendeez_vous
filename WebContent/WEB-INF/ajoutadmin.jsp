        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Ajout ADMIN</li>
            </ol>
          </div>
        </div>
            ...
            <section class="panel">
              ...
              <form class="form-validate form-horizontal" id="feedback_form" method="POST" >
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="cpassword" name="password" minlength="6" type="password" required />
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="cnum_hopital" name="num_hopital" minlength="1" type="text" required />
                      </div>
                    </div>
