  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Médecin</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-laptop"></i>Liste Médecin</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i class="icon_profile"></i> Num Medcin</th>
                    ...
                    <th><i class="icon_mobile"></i>Num Téléphone</th>
                    
                  </tr>
                 <c:forEach items="${l}" var="med">
                  
                  <tr >
                  
                    <td ><c:out value="${med.getId_medcin()}"></c:out></td>
                    
                    <td><c:out value="${med.getNom()}"></c:out></td>
                     <td><c:out value="${med.getPrenom()}"></c:out></td>
                    
                    <td><c:out value="${med.getEmail()}"></c:out></td>
                    <td><c:out value="${med.getRegion()}"></c:out></td>
                    <td><c:out value="${med.getNum_hopital()}"></c:out></td>
                    <td><c:out value="${med.getNum_tel()}"></c:out></td>
