        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Liste RDV</li>
            </ol>
          </div>
        </div>
          ...
          <div class="col-lg-12">
			...
			%> 
                  ...
                  <tr >
                    ...
                    <td><c:out value="<%= rend1.getString(2)%>"></c:out><c:out value=" "></c:out><c:out value="<%= rend1.getString(3)%>"></c:out></td>
                    <td><c:out value="<%= rend1.getString(4)%>"></c:out><c:out value=" "></c:out><c:out value="<%= rend1.getString(5)%>"></c:out></td>
                    ...
                    <td>
                    <form method="get" name="monform" >
                
                      <div class="btn-group" >
                      <input type="hidden" value="<%= rend1.getInt(1) %>" name="num"/>
                          <a  href="/rendez_vous/modif_rendez_vous?num=<%= rend1.getInt(1) %>" onClick="javascript:monform.submit();return false;" class="btn btn-primary" name="update" ><i class="icon_plus_alt2"></i></a>
                      </div>
                      </form>
                   </td>
                   ...
                   <td>
                    <form  name="monform2" >
                      ...
                      <div class="btn-group" >
                      <input type="hidden" value="<%= rend1.getInt(1) %>" name="num"/>
                          <a  href="/rendez_vous/modif_rendez_vous2?num=<%= rend1.getInt(1) %>" onClick="javascript:monform2.submit();return false;" class="btn btn-danger" name="update" ><i class="icon_close_alt2"></i></a>
                      </div>
                      </form>
                   </td>
