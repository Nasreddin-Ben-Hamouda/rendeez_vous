   ...
   <%@ include file="headeradmin.jsp" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Liste RDV</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-laptop"></i>Ajout RDV</li>
            </ol>
          </div>
        </div>
             ...
             <form class="form-validate form-horizontal" id="feedback_form" method="POST" >
              <%
                    ...
                    <div class="form-group ">
                      <label for="nom" class="control-label col-lg-2">Nom Patient <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="mat" minlength="1" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                       <label for="nom" class="control-label col-lg-2">Liste Medcin <span class="required">*</span></label>
                      <div class="col-lg-6 ">
                        <select class="form-control input-sm " name="num_med">
                                              <option value="0">choisir un medcin</option>
                                    <% ResultSet res=(ResultSet)request.getAttribute("res1"); 
                                    while(res.next()){
                                    
                                    %>          
                                              <option value="<c:out value="<%= res.getInt(1) %>"></c:out>"><c:out value="<%= res.getString(2) %>"></c:out><c:out value=" "></c:out><c:out value="<%= res.getString(3) %>"></c:out></option>
                    ...
                    <div class="form-group ">
                      <label for="date_naiss" class="control-label col-lg-2">Date  <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="date" name="date"  type="date" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="date_naiss" class="control-label col-lg-2">Time  <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="time"  type="time" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="date_naiss" class="control-label col-lg-2">Region Patient <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="reg"  type="text" required />
                      </div>
                    </div>
