        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Modier ADMIN</li>
            </ol>
          </div>
        </div>
            ...
            <c:forEach items="${adminArray}" var="admin">
              <form class="form-validate form-horizontal" id="feedback_form" method="POST" >
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control" id="cname" name="nom"  value="${admin.getNom()}" minlength="4" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="prenom" class="control-label col-lg-2">Prenom <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="cprenom" name="prenom"  value="${admin.getPrenom()}" minlength="5" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2">E-Mail <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control " id="cemail" type="email" name="email"  value="${admin.getEmail()}" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="password" class="control-label col-lg-2">Password <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="cpassword" name="password" minlength="6" type="password" value="${admin.getPassword()}" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="sexe" class="control-label col-lg-2">Sexe <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="csexe" name="sexe" minlength="1" type="text"  value="${admin.getSexe()}" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="num_tel" class="control-label col-lg-2">Numéro du téléphone <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="cnum_tel" name="num_tel" minlength="8" type="text"  value="${admin.getNum_tel()}" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="region" class="control-label col-lg-2">Region <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="cregion" name="region" minlength="4"  value="${admin.getRegion()}" type="text" required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="date_naiss" class="control-label col-lg-2">Date De Naissance <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="date_naiss" name="date_naiss"  type="date"  value="${admin.getDate_naiss()}" required />
                      </div>
                    </div>
                    
                    <div class="form-group ">
                      <label for="num_hopital" class="control-label col-lg-2">Num_hopital <span class="required">*</span></label>
                      <div class="col-lg-6">
                        <input class="form-control" id="cnum_hopital" name="num_hopital" minlength="1" type="text"  value="${admin.getNum_hopital()}" required />
                      </div>
                    </div>
